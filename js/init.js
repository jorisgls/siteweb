...
var bgOverlayColor1 = '#556270';
var bgOverlayColor2 = '#FF6B6B';
var bgOverlayOpacity = '0.75'; // Set 0 if you do't need to overlay color
var firefly=true;
...
if ($(".bg-overlay").length) {
    $(".bg-overlay").css('background-color', bgOverlayColor1)
                    .css("background", "-webkit-linear-gradient(90deg, " + "rgba(" + hexToRgb(bgOverlayColor1).r + "," + hexToRgb(bgOverlayColor1).g + "," + hexToRgb(bgOverlayColor1).b + "," + bgOverlayOpacity + ")" + " 10%, " + "rgba(" + hexToRgb(bgOverlayColor2).r + "," + hexToRgb(bgOverlayColor2).g + "," + hexToRgb(bgOverlayColor2).b + "," + bgOverlayOpacity + ")" + " 90%)")
                    .css("background", "-moz-linear-gradient(90deg, " + "rgba(" + hexToRgb(bgOverlayColor1).r + "," + hexToRgb(bgOverlayColor1).g + "," + hexToRgb(bgOverlayColor1).b + "," + bgOverlayOpacity + ")" + " 10%, " + "rgba(" + hexToRgb(bgOverlayColor2).r + "," + hexToRgb(bgOverlayColor2).g + "," + hexToRgb(bgOverlayColor2).b + "," + bgOverlayOpacity + ")" + " 90%)")
                    .css("background", "-ms-linear-gradient(90deg, " + "rgba(" + hexToRgb(bgOverlayColor1).r + "," + hexToRgb(bgOverlayColor1).g + "," + hexToRgb(bgOverlayColor1).b + "," + bgOverlayOpacity + ")" + " 10%, " + "rgba(" + hexToRgb(bgOverlayColor2).r + "," + hexToRgb(bgOverlayColor2).g + "," + hexToRgb(bgOverlayColor2).b + "," + bgOverlayOpacity + ")" + " 90%)")
                    .css("background", "-o-linear-gradient(90deg, " + "rgba(" + hexToRgb(bgOverlayColor1).r + "," + hexToRgb(bgOverlayColor1).g + "," + hexToRgb(bgOverlayColor1).b + "," + bgOverlayOpacity + ")" + " 10%, " + "rgba(" + hexToRgb(bgOverlayColor2).r + "," + hexToRgb(bgOverlayColor2).g + "," + hexToRgb(bgOverlayColor2).b + "," + bgOverlayOpacity + ")" + " 90%)")
                    .css("background", "linear-gradient(90deg, " + "rgba(" + hexToRgb(bgOverlayColor1).r + "," + hexToRgb(bgOverlayColor1).g + "," + hexToRgb(bgOverlayColor1).b + "," + bgOverlayOpacity + ")" + " 10%, " + "rgba(" + hexToRgb(bgOverlayColor2).r + "," + hexToRgb(bgOverlayColor2).g + "," + hexToRgb(bgOverlayColor2).b + "," + bgOverlayOpacity + ")" + " 90%)");
}
