...
<html>
	...
	<div class="center_c">
		<div class="arrow_box">
			...
			<div id="login-column-1">
				<label style="font-size: 13px; display: block; margin-bottom: 2px;">Pseudo</label>
			...
			<div id="login-column-2">
            	<label style="font-size: 13px; display: block; margin-bottom: 2px;">Mot de passe</label>
	...
	<div id="copyright">2015 - 2016<br>
© Jabbo New Time est un fansite pour JabboHotel.eu, nous somme un site à but non lucratif !
