	...
	<div class="wrapper">
		...
		<aside class="sidebar">
			<ul class="main-nav">
				...
				<?php $hks = $bdd->query("SELECT * FROM retrophp_hk WHERE pagename = 'recrutements'"); $hksecu = $hks->fetch(PDO::FETCH_ASSOC); if($User->rank >= $hksecu['rank']) { ?>
				<?php if($pageid == 5) { ?>
				<li class="main-nav--active">
				<?php } else { ?> 
				<li class="main-nav--collapsible">
				<?php } ?>
					<a class="main-nav__link" style="text-decoration:none;" href="<?php print URL; ?>/recruts/recrutements">
